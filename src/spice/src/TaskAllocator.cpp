...
{
public:
    Node(uint8_t id_, int8_t work_type_, std::vector<Node *> children_)
    {
        this->id = id_;
...
{
public:
    void tree_type_overview()
    {
        spice_msgs::msg::Task task;
        Node node0(0, 1, {});
        Node node1(1, 1, {});
        Node node2(2, 2, {&node0});
        Node node3(3, 1, {});
        Node node4(4, 3, {&node1});
        Node node5(5, 1, {});
        Node node6(6, 3, {&node2, &node3});
        Node node7(7, 2, {&node4, &node5});
        Node node8(8, 1, {});
        Node node9(9, 4, {&node6, &node7, &node8});
        ...
        void tree_type_hs()
    {
        ...
        Node node1(1, 1, {});
        Node node2(2, 2, {&node0});
        Node node3(3, 3, {&node1});
        Node node4(4, 3, {&node2});
        Node node5(5, 2, {&node3});
        Node node6(6, 4, {&node4, &node5});
    ...
    spice_msgs::msg::Task to_task_msg_overview()
    {
        ...
        for (size_t j = 0; j < this->nodes.size(); j++)
        {
            ...
            node_msg.work.type = (int8_t)this->nodes[j].work_type;
        ...
        spice_msgs::msg::Task to_task_msg_hs()
    {
        spice_msgs::msg::Task task_msg;
        spice_msgs::msg::Layer layer_msg;
        for (size_t j = 0; j < this->nodes.size(); j++)
...
public:
    ...
    void AllocateTasks()
    {
        ...
        for (const auto &robot : robots_)
        {
            ...
            jobRequest->task = this->tree.to_task_msg_hs();
