...
DEFAULT_MAP_NAME = "A4_legless.yaml" # change to the name.yaml of the default map here
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[
                {'work_cell_rep_slope': 0.075}, # workcell repulsion for queue pos
                {'carrier_bot_rep_slope': 0.1}, # carrier bot repulsion
                {'wall_rep_slope': 0.075}, #static map obstacle repulsion
                {'queue_rep_slope': 0.1}, # other queue point repulsion
                {'plan_rep_slope': 0.1}, # robot plans repulsion
                {'work_cell_att_slope':  0.006}, # own workcell attraction
